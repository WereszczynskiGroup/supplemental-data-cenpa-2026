...
for i in {1..4}; do
        traj="CSexnotailH3_${i}.nowat.nc"
        outfile="CSexnotailH3-dist-ete_entry${i}.dat"
...
distance end-to-end :1-5,290-294 :73-74 out CSexnotailH3-dist-ete_entry.dat
run
EOF
...
for i in {1..4}; do
        traj="CSexnotailH3_${i}.nowat.nc"
        outfile="CSexnotailH3-dist-ete_exit${i}.dat"
...
trajin CSexnotailH3_3.nowat.nc
trajin CSexnotailH3_4.nowat.nc
distance end-to-end :143-152 :73-74 out CSexnotailH3-dist-ete_exit.dat
run
EOF
