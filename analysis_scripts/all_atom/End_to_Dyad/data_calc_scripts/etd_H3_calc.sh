...
for i in {1..4}; do
        traj="H3_${i}.nowat.nc"
        outfile="H3-dist-ete_entry${i}.dat"
...
distance end-to-end :1-5,290-294 :73-74 out H3-dist-ete_entry.dat
run
EOF
...
for i in {1..4}; do
        traj="H3_${i}.nowat.nc"
        outfile="H3-dist-ete_exit${i}.dat"
...
trajin H3_3.nowat.nc
trajin H3_4.nowat.nc
distance end-to-end :143-152 :73-74 out H3-dist-ete_exit.dat
run
EOF
