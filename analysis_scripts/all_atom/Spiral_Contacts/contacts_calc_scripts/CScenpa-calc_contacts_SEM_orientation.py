...
# Input files
# ------------------------
pdb_file  = "CScenpa_1.init_for_cafemol.pdb"
traj_file = "total.xtc"

# Output
output_file = "CScenpa_tail_contacts_inside_outside_freq_SEM.dat"

# ------------------------
# Parameters
# ------------------------
entrytail_residues = '790:832'
...
histone_core = u.select_atoms("(resid 381-406 or resid 876-901) and protein")
