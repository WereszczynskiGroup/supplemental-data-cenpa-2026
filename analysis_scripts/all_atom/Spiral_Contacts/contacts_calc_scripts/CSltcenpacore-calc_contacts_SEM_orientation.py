...
# Input files
# ------------------------
pdb_file  = "CSltcenpacore_1.init_for_cafemol.pdb"
traj_file = "total.xtc"

# Output
output_file = "CSltcenpacore_tail_contacts_inside_outside_freq_SEM.dat"

# ------------------------
# Parameters
# ------------------------
entrytail_residues = '791:834'
...
histone_core = u.select_atoms("(resid 382-407 or resid 878-903) and protein")
