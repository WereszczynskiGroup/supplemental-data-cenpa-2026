...
subplots_data = [
    {
        "cg_entry": "cenpa-dist-etd_entry1.dat",
        "cg_exit":  "cenpa-dist-etd_exit1.dat",
        "aa_entry": "CScenpa-dist-ete_entry1.dat",
        "aa_exit":  "CScenpa-dist-ete_exit1.dat",
        "header": "Run 1"
    },
    {
        "cg_entry": "cenpa-dist-etd_entry2.dat",
        "cg_exit":  "cenpa-dist-etd_exit2.dat",
        "aa_entry": "CScenpa-dist-ete_entry2.dat",
        "aa_exit":  "CScenpa-dist-ete_exit2.dat",
        "header": "Run 2"
    },
    {
        "cg_entry": "cenpa-dist-etd_entry3.dat",
        "cg_exit":  "cenpa-dist-etd_exit3.dat",
        "aa_entry": "CScenpa-dist-ete_entry3.dat",
        "aa_exit":  "CScenpa-dist-ete_exit3.dat",
        "header": "Run 3"
    },
    {
        "cg_entry": "cenpa-dist-etd_entry4.dat",
        "cg_exit":  "cenpa-dist-etd_exit4.dat",
        "aa_entry": "CScenpa-dist-ete_entry4.dat",
        "aa_exit":  "CScenpa-dist-ete_exit4.dat",
        "header": "Run 4"
    }
]
...
for i, subplot_data in enumerate(subplots_data):
    ...
    ax.plot(cg_time_us, cg_entry, color='C1', alpha=1.0, label='CG Entry')

    # CG EXIT
    cg_frame, cg_exit = np.loadtxt(subplot_data["cg_exit"], usecols=(0, 1), unpack=True, comments=('#', '@', '&'))
    cg_time_us = cg_frame * CG_US_PER_FRAME
    ax.plot(cg_time_us, cg_exit, color='C1', alpha=0.5, label='CG Exit')
...
plt.tight_layout()
plt.savefig('time_etd_plots_ZOOMED_IN/cenpa_AA_CG_2us_EtD_TIME.pdf')
plt.savefig('time_etd_plots_ZOOMED_IN/cenpa_AA_CG_2us_EtD_TIME.png')
plt.show()
