...
subplots_data = [
	{"files": ["H3withcenpa_latch_helix-dist-etd_entry1.dat"], "header": "Run 1 Entry", "color": 'C7', "alpha_values": [1.0]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_exit1.dat"], "header": "Run 1 Exit", "color": 'C7', "alpha_values": [0.5]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_entry2.dat"], "header": "Run 2 Entry", "color": 'C7', "alpha_values": [1.0]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_exit2.dat"], "header": "Run 2 Exit", "color": 'C7', "alpha_values": [0.5]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_entry3.dat"], "header": "Run 3 Entry", "color": 'C7', "alpha_values": [1.0]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_exit3.dat"], "header": "Run 3 Exit", "color": 'C7', "alpha_values": [0.5]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_entry4.dat"], "header": "Run 4 Entry", "color": 'C7', "alpha_values": [1.0]},
	{"files": ["H3withcenpa_latch_helix-dist-etd_exit4.dat"], "header": "Run 4 Exit", "color": 'C7', "alpha_values": [0.5]}
]
...
plt.tight_layout()
#plt.savefig('time_etd_plots/CENPA-LATCH-HELIX_H3-CORE_EtD_TIME.pdf')
plt.show()
